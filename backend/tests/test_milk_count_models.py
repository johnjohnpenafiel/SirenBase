"""
Tests for Milk Count models.

Tests cover:
- MilkType model operations
- MilkCountParLevel model operations
- MilkCountSession model operations and status transitions
- MilkCountEntry model operations and calculations
"""
import pytest
...
class TestMilkCountParLevelModel:
    """Tests for MilkCountParLevel model."""
...
class TestMilkCountSessionModel:
    """Tests for MilkCountSession model."""
...
class TestMilkCountEntryModel:
    """Tests for MilkCountEntry model."""
