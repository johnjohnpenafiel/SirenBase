/**
 * Milk Order Progress Circle
 *
 * 4-segment donut chart showing today's milk order phase progress.
...
import type { MilkOrderSession } from "@/types";
...
export function MilkOrderProgress() {
