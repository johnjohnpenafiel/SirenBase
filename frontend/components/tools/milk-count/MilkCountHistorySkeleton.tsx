/**
 * Milk Count History Skeleton
 *
 * Loading placeholder for the milk count history page.
...
interface MilkCountHistorySkeletonProps {
  count?: number;
}
...
export function MilkCountHistorySkeleton({ count = 5 }: MilkCountHistorySkeletonProps) {
  return (
