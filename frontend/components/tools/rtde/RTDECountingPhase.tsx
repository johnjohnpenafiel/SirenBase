      ...
      <div className="md:hidden flex justify-center gap-3 px-4 py-3 flex-shrink-0">
        {showPreviousButton && (
          <Button
            ...
            size="lg"
            onClick={onPrevious}
            className="flex-1 h-12 border border-zinc-300/30 shadow-[0_0_4px_rgba(0,0,0,0.1)] bg-zinc-200/50 text-zinc-700 hover:bg-zinc-200/70"
          >
          ...
          <div className="hidden md:flex items-center justify-between gap-3">
            {showPreviousButton && (
              <Button
                ...
                size="lg"
                onClick={onPrevious}
                className="flex-1 sm:flex-initial h-11 border border-zinc-300/30 shadow-[0_0_4px_rgba(0,0,0,0.1)] bg-zinc-200/50 text-zinc-700 hover:bg-zinc-200/70"
              >
                <ChevronLeft className="h-5 w-5 mr-2" />
                Previous
              </Button>
            ...
            {isLastItem ? (
              ...
              <Button
                ...
                size="lg"
                onClick={onNext}
                className="flex-1 sm:flex-initial ml-auto h-11 border border-zinc-300/30 shadow-[0_0_4px_rgba(0,0,0,0.1)] bg-zinc-200/50 text-zinc-700 hover:bg-zinc-200/70"
              >
                Next
                <ChevronRight className="h-5 w-5 ml-2" />
              </Button>
