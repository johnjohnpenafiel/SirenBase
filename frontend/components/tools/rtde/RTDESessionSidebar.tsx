...
export function RTDESessionSidebar({
  ...
  return (
    <aside className="hidden md:flex md:flex-col w-64 lg:w-80 border-r border-neutral-300/80">
      {/* Fixed title header */}
      <div className="px-4 py-3 border-b border-neutral-300/80">
      ...
      <div className="border-t border-neutral-300/80 bg-background px-4 py-4 md:py-6">
        <Button
          size="lg"
          onClick={onStartPull}
          disabled={!isCountingPhase}
